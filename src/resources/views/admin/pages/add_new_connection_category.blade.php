...
@section('child-content')
    <h1 class="h3 mb-4 text-gray-800">Conenction Categories</h1>
    <p class="mb-4">Customize all connection categories of THC platform</p>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h3 class="m-0 font-weight-bold text-primary">Add New Connection Category</h3>
        </div>
        <form name="addConnectionCategoryForm" method="POST" action="{{route('admin_add_connection_categories')}}" enctype="multipart/form-data">
        <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" rows="3" name="description"
                              placeholder="Give a description for your Connection Category, if you have one">{{ old('description') }}</textarea>
